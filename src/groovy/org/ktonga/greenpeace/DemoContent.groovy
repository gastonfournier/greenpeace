...
class DemoContent {
	...
	def createProject(def num, def env1, def env2) {
		...
		p.save(flush: true)
		println "****************" + p.errors
		Version v1 = new Version(name: "v1.1", matchingPrefix: "1.1")
		v1.propertyDefs = toString(["p${num}.prop1": "p${num} value1", "p${num}.prop2": "p${num} value2", "p${num}.prop3": "p${num} value3"])
		Version v2 = new Version(name: "v1.2", matchingPrefix: "1.2")
		...
		o1 = new Overrides(version1: v1)
		o1.propertyValues = toString(["p${num}.prop1": "p${num} ${e.name} override1", "p${num}.prop2": "p${num} ${e.name} override2"])
		o2 = new Overrides(version1: v2)
		o2.propertyValues = toString(["p${num}.prop4": "p${num} ${e.name} override4", "p${num}.prop5": "p${num} ${e.name} override5"])
